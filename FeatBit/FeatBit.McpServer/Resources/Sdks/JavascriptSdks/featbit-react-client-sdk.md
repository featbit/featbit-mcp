...
Description: The React SDK builds on FeatBit's JavaScript SDK to provide a better integration for use in React applications. As a result, much of the JavaScript SDK functionality is also available for the React SDK to use. 
...
(async () => {
  const configWithAnonymousUser = {
    options: {
      ...
      streamingUrl: 'THE STREAMING URL', // e.g. wss://app-eval.featbit.co 
      eventsUrl: 'THE EVENTS URL' // e.g. https://app-eval.featbit.co
    }
  };
...
Please review github online repository for more examples:

[https://github.com/featbit/featbit-react-client-sdk/](https://github.com/featbit/featbit-react-client-sdk/)
