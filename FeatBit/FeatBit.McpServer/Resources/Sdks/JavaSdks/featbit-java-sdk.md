# FeatBit Feature Flag Server-Side SDK for Java

## Introduction

The FeatBit Server-Side SDK for Java is designed primarily for use in multi-user systems such as web servers and applications.
...
# FeatBit Feature Flag Server-Side SDK for Java OpenFeature Provider

Source: https://github.com/featbit/featbit-openfeature-provider-java-server/edit/main/README.md
